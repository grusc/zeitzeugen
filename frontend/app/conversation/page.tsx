  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const aiMessage: Message = {
        ...
        content:
          data.message || "Entschuldigung, ich konnte deine Frage nicht verstehen. Könntest du es anders formulieren?",
        sender: "ai",
        timestamp: new Date(),
      }
                  ...
                  >
                    <div
                      className={`max-w-[80%] rounded-lg p-3 ${
                        message.sender === "user" ? "bg-blue-900/80 text-white" : "bg-amber-800/80 text-white"
                      }`}
                    >
